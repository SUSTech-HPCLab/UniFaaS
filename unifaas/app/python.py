    ...
    def wrapper(*args, **kwargs):
        ...
        def inject_exception(thread):
            ctypes.pythonapi.PyThreadState_SetAsyncExc(
                ...
                ctypes.py_object(unifaas.app.errors.AppTimeout)
            )
...
class PythonApp(AppBase):
    ...
    def __init__(self, func, data_flow_kernel=None, cache=False, executors='all', ignore_for_cache=[], join=False,never_change=False):
        super().__init__(
            wrap_error(func),
