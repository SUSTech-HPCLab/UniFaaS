...
class UniFaaSExecutor(metaclass=ABCMeta):
    ...
    In addition to the listed methods, a UniFaaSExecutor instance must always
    have a member field:
    ...
    An executor may optionally expose:
       ...
       storage_access: List[unifaas.data_provider.staging.Staging] - a list of staging
              ...
              ``unifaas.data_provider.staging.default_staging`` will be used by the
              staging code.
    ...
    def scaling_enabled(self) -> bool:
        ...
        The callers of UniFaaSExecutors need to differentiate between Executors
    ...
    def monitor_resources(self) -> bool:
        ...
        Unifaas resource monitoring conflicts with execution styles which use threads, and
    ...
    def error_management_enabled(self) -> bool:
        ...
        :class:unifaas.executors.status_handling.BlockProviderExecutor, which interested executors
        should inherit from. Noop versions of methods that are related to status handling and
        running unifaas tasks through workers are implemented by
        :class:unifaas.executors.status_handling.NoStatusHandlingExecutor.
        """
        pass
