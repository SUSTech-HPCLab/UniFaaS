...
class TaskStatusTracker:
    ...
    def report_status(self):
        while True:
            ...
            exp_logger.info(f"[TaskkStatusTracker] ready: {self.ready_tasks}, not ready: {self.not_ready_tasks}, executed: {self.executed_tasks}, running: {self.running_tasks}, ready to launch: {self.ready_to_launch_tasks}")
