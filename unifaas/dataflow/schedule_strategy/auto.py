...
class AutoScheduling:
    ...
    def __init__(self, resource_poller, execution_predictor, transfer_predictor, data_transfer_manager):
        ...
        self.processing_stage = 0 # 0 means data locality scheduling, 1 means heft scheduling
    ...
    def _analyze_workflow(self, workflow_graph,id_to_task):
        ...
        in_history, out_history = self.execution_predictor.look_up_history_model(self.func_dict.keys())
        ...
        if self.processing_stage == 0:
            ...
            for child in child_task_id_list:
                ...
                with child_task['task_launch_lock']:
                    ...
                    self.data_transfer_manager.handle_task_record_data_managing(child_task, input_data=task_res, invoke=True)
