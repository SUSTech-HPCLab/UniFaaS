...
def ic_optimal_scheduling(graphHelper,execution_predictor):
    ...
    check_sufficiency_of_info = ic_sch.check_sufficiency_of_info()
    ic_sch.advanced = check_sufficiency_of_info
    peak_count = ic_sch.calculate_peak_task_count()
    execution_order_id = ic_sch.ic_optimal_based_on_priority()
