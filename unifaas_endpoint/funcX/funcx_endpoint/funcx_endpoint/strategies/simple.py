...
class SimpleStrategy(BaseStrategy):
    ...
    def _strategize(self, *args, **kwargs):
        ...
        logger.debug(f"The number of current active_tasks {active_tasks} nodes_per_block {nodes_per_block} tasks_per_node {tasks_per_node}")
        ...
        # More tasks than the available slots.
            ...
            # Case 2b
                ...
                logger.info(f"Strategy: Case.2b. Excess blocks: {excess_blocks} active_tasks: {active_tasks} active_slots: {active_slots} ")
            ...
            logger.info(f"Strategy: Case.4. active_tasks: {active_tasks} active_slots: {active_slots}")
            if active_blocks < max_blocks:
